...
include 'utils/type_icon.php';
include 'utils/files.util.php';
      ...
      <div class="container">
         ...
         <table class="table table-hover border">
            ...
            <tbody>
               ...
               <?php foreach($directories as $info) { ?>
                  <tr>
                     <td>
                     ...
                     <td>
                        <span><i class="fa fa-download action"></i></button>
                        <span><i class="fa fa-edit action"></i></button>
                        <span><a href="home.php?delete=<?= $info["Name"]?>" data-toggle="modal" data-target="#confirm-delete<?= $info["Base"] ?>"><i class="fa fa-trash action"></i></a>
                        <div class="modal fade" id="confirm-delete<?= $info["Base"] ?>">
                           <form method="post" action="home.php?delete=<?= $info["Name"]?>"><div class="modal-dialog">
                              <div class="modal-content">
                                 <div class="modal-header">
                                 <h4 class="modal-title">Xóa <?php if ($info["Type"] == 'Folder') { echo "thư mục"; } else echo "tập tin";  ?></h4>
                                 <button type="button" class="close" data-dismiss="modal">&times;</button>
                                 </div>

                                 <div class="modal-body">
                                    Bạn có chắc rằng muốn xóa <?php if ($info["Type"] == 'Folder') { echo "thư mục"; } else echo "tập tin";  ?> <strong><?= $info["Name"] ?></strong>
                                 </div>
                                 ...
                                 <div class="modal-footer">
                                    ...
                                    <input type="reset" class="btn btn-secondary" data-dismiss="modal" value="Không"/>
                                 </div>
                              </div>
                           </form>
                        </div>
